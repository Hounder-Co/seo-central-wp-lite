...
<nav class="seo-central-partials-nav-wrapper">
  ...
  <ul class="seo-central-partials-nav-links-wrapper">
    ...
    <li class="seo-central-partials-nav-link-item"><a href='admin.php?page=seo-central-dashboard' class="seo-central-partials-nav-link"><?php echo esc_html__('Dashboard', 'seo-central-lite'); ?></a></li>
    <li class="seo-central-partials-nav-link-item"><a href='admin.php?page=seo-central-file-editor' class="seo-central-partials-nav-link"><?php echo esc_html__('File Editor', 'seo-central-lite'); ?></a></li>
    <li class="seo-central-partials-nav-link-item"><a href='admin.php?page=seo-central-redirects' class="seo-central-partials-nav-link"><?php echo esc_html__('Redirects', 'seo-central-lite'); ?></a></li>
