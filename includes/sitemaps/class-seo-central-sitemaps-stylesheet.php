<?php
/**
 * Sitemaps: Seo_Central_Sitemaps_Stylesheet class
 *
...
class Seo_Central_Sitemaps_Stylesheet {
	/**
...
XSL;
		 ...
		 */
		return apply_filters( 'Seo_Central_Sitemaps_stylesheet_content', $xsl_content );
	}
...
XSL;
		 ...
		 * @param string $xsl_content Full content for the XML stylesheet.
		 */
		return apply_filters( 'Seo_Central_Sitemaps_stylesheet_index_content', $xsl_content );
	}
...
EOF;
		 ...
		 */
		return apply_filters( 'Seo_Central_Sitemaps_stylesheet_css', $css );
	}
}