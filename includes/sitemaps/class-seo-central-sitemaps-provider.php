<?php
/**
 * Sitemaps: Seo_Central_Sitemaps_Provider class
 *
...
/**
 * Class Seo_Central_Sitemaps_Provider.
 *
 * @since 5.5.0
 */
#[AllowDynamicProperties]
abstract class Seo_Central_Sitemaps_Provider {
	/**
	 * Provider name.
	 *
	...
	public function get_sitemap_entries() {
		...
		foreach ( $sitemap_types as $type ) {
			for ( $page = 1; $page <= $type['pages']; $page++ ) {
				 ...
				 */
				$sitemap_entry = apply_filters( 'Seo_Central_Sitemaps_index_entry', $sitemap_entry, $this->object_type, $type['name'], $page );
