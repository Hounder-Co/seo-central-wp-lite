<?php
/**
 * Sitemaps: Seo_Central_Sitemaps_Renderer class
 *
...
/**
 * Class Seo_Central_Sitemaps_Renderer
 *
 * @since 5.5.0
 */
...
class Seo_Central_Sitemaps_Renderer {
	...
	/**
	 * Seo_Central_Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/central-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'Seo_Central_Sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/central-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'Seo_Central_Sitemaps_stylesheet_index_url', $sitemap_url );
	}
