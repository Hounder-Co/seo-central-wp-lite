...
require_once(__DIR__.'/../class-seo-central-sitemaps-provider.php');
/**
 * Sitemaps: Seo_Central_Sitemaps_Posts class
 *
 ...
 * @since 5.5.0
 */
class Seo_Central_Sitemaps_Posts extends Seo_Central_Sitemaps_Provider {
	/**
	 * Seo_Central_Sitemaps_Posts constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_object_subtypes() {
		 ...
		 */
		return apply_filters( 'Seo_Central_Sitemaps_post_types', $post_types );
	}
	...
	public function get_url_list( $page_num, $object_subtype = '' ) {
		...
		$url_list = apply_filters(
			'Seo_Central_Sitemaps_posts_pre_url_list',
			null,
			$post_type,
			$page_num
		);
		...
		if ( 'page' === $post_type && 1 === $page_num && 'posts' === get_option( 'show_on_front' ) ) {
			 ...
			 */
			$sitemap_entry = apply_filters( 'Seo_Central_Sitemaps_posts_show_on_front_entry', $sitemap_entry );
		...
		foreach ( $query->posts as $post ) {
			 ...
			 */
			$sitemap_entry = apply_filters( 'Seo_Central_Sitemaps_posts_entry', $sitemap_entry, $post, $post_type );
			$url_list[]    = $sitemap_entry;
		}
	...
	public function get_max_num_pages( $object_subtype = '' ) {
		 ...
		 * @param string   $post_type     Post type name.
		 */
		$max_num_pages = apply_filters( 'Seo_Central_Sitemaps_posts_pre_max_num_pages', null, $post_type );
	...
	protected function get_posts_query_args( $post_type ) {
		 ...
		 */
		$args = apply_filters(
			'Seo_Central_Sitemaps_posts_query_args',
			array(
				'orderby'                => 'ID',
				'order'                  => 'ASC',
				'post_type'              => $post_type,
				'posts_per_page'         => $this->seo_central_get_max_urls( $this->object_type ),
